import mongeMeditando from "../assets/monkFooter.svg"

const Footer = () => {
  return (
    <footer className="bg-gradient-to-t from-black to-gray-900/25 py-6 px-4 
    grid grid-cols-3 grid-rows-auto sm:px-9 lg:px-16 md:px-8 xl:px-12">
        <div className=" text-primary col-span-3 grid gap-2 sm:gap-5">
            ...
            {/* <div>
                <h3 className="text-base sm:text-2xl">Contato</h3>
        ...
        <div className="row-start-2 col-start-2 col-span-2 grid">
            <img className="w-52 h-auto sm:w-80 justify-self-end" src={mongeMeditando} alt="" />
        </div>
    </footer>
  )
}
